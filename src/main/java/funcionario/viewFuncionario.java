...
public class viewFuncionario extends javax.swing.JFrame {
    ...
    private void resizeImage() {
        ...
        if (icon != null) {
            jLabel1.setIcon(new ImageIcon(icon.getImage().getScaledInstance(jLabel1.getWidth(), jLabel1.getHeight(), java.awt.Image.SCALE_SMOOTH)));
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/Main Dashboard.png"))); // NOI18N
